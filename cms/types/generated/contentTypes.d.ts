...
export interface ApiPhotoPhoto extends Schema.CollectionType {
	...
	attributes: {
		all: Attribute.Media & Attribute.Required
		header: Attribute.Media & Attribute.Required
		createdAt: Attribute.DateTime
		updatedAt: Attribute.DateTime
		publishedAt: Attribute.DateTime
		createdBy: Attribute.Relation<'api::photo.photo', 'oneToOne', 'admin::user'> & Attribute.Private
		updatedBy: Attribute.Relation<'api::photo.photo', 'oneToOne', 'admin::user'> & Attribute.Private
	}
}
